        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false}>
          <View className="flex flex-row items-center gap-5 pb-5">
            ...
            >
              ...
              <Text
                className={`font-bold ${
                  selectedLocation === "daklak" ? "red" : "black"
                }`}
              >
                Dak Lak
              </Text>
            ...
            >
              ...
              <Text
                className={`font-bold ${
                  selectedLocation === "vinhhalong" ? "red" : "black"
                }`}
              >
                Vinh Ha Long
              </Text>
            ...
            >
              ...
              <Text
                className={`font-bold ${
                  selectedLocation === "hanoi" ? "red" : "black"
                }`}
              >
                Ha Noi
              </Text>
